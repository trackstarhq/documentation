...
| `created_date` | When the file was generated |
...
```bash
curl -X GET "https://production.trackstarhq.com/carrier/files?created_date[gte]=2026-03-01T00:00:00Z&created_date[lte]=2026-03-31T23:59:59Z" \
  -H "x-trackstar-api-key: YOUR_API_KEY" \
  -H "x-trackstar-access-token: YOUR_ACCESS_TOKEN"
```
...
```bash
curl -X GET "https://production.trackstarhq.com/carrier/files/2026-03-01T00:00:00/8f2c1b9e/invoice.csv" \
  -H "x-trackstar-api-key: YOUR_API_KEY" \
  -H "x-trackstar-access-token: YOUR_ACCESS_TOKEN"
```

See [Get Carrier File](/api-reference/carrier-api/files/get-item). This is also how you get a new URL for a file you already listed, without paging through the list endpoint again.
