...
<CardGroup cols={2}>
  <Card title="ERP Order Management" icon="file-invoice" href="/use-cases/erp-order-management">
    Sync sales and purchase orders, inventory, and master data from ERP systems.
  </Card>
</CardGroup>
