...
Curated subset of columns (with names added for readability). The downloadable CSV is the raw DHL eCom format — 79 columns, no header row.

```csv
Sold_To*,PUDATE*,Internal_Tracking_Num:,Material_or_VAS_Desc*,ACTWeight*,Pricing_Zone*,Charge*,ZFuel*
2684030563,2026-03-27,7290846040,DHL SmartMail Parcel Ground,3.21,5,6.22,0.45
2684030563,2026-03-26,2052047713,DHL SmartMail Parcel Expedited,3.72,6,5.82,0.39
2684030563,2026-03-08,0065880238,DHL SmartMail Parcel Expedited,4.64,3,7.71,0.40
2684030563,2026-03-03,0559073905,DHL SmartMail Parcel Expedited,4.72,2,5.96,0.30
2684030563,2026-03-25,5335895286,DHL SmartMail Parcel Expedited,1.47,5,7.54,0.44
```

## Download

<a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/assets/carrier-samples/dhl-ecom.csv" download>Download full sample CSV (1 HDR row + 20 DTL rows, 79 columns, no header row)</a>
