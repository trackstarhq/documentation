...
<Tabs>
  <Tab title="United States">
    ...
    <a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/fedex-us.csv" download>Download FedEx US sample CSV (22 rows, 210 columns)</a>
  ...
  <Tab title="International (UK / NL)">
    ...
    <div><a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/fedex-uk.csv" download>Download FedEx UK sample CSV (22 rows, 168 columns, GBP)</a></div>

    <div><a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/fedex-nl.csv" download>Download FedEx NL sample CSV (22 rows, 168 columns, EUR)</a></div>
