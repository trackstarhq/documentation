...
<a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/assets/carrier-samples/royal-mail.csv" download>Download full sample CSV (2 header rows + 25 data rows, 38 columns)</a>
