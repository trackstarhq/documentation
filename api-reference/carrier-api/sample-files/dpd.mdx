...
<Tabs>
  <Tab title="English">
    ...
    <a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/dpd-english.csv" download>Download DPD English sample CSV (25 rows, 43 columns, semicolon-delimited)</a>
  ...
  <Tab title="Dutch">
    ...
    <a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/dpd-dutch.csv" download>Download DPD Dutch sample CSV (25 rows, semicolon-delimited)</a>
  ...
  <Tab title="German">
    ...
    <a href="https://cdn.jsdelivr.net/gh/trackstarhq/documentation@main/carrier-samples/dpd-german.csv" download>Download DPD German sample CSV (25 rows, semicolon-delimited)</a>
