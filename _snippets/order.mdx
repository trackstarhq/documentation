...
<ResponseField name="warehouse_customer_id" type="string or null">
    The ID of the merchant/tenant/customer that owns the order.
  ...
  <ResponseField name="total_price" type="float or null">
    The total price a customer paid for the order.
  </ResponseField>

  <ResponseField name="total_tax" type="float or null">
    The total tax on the order.
  </ResponseField>


  <ResponseField name="total_discount" type="float or null">
    The total amount discounted from the order.
  </ResponseField>

  <ResponseField name="total_shipping" type="float or null">
    The total shipping cost for the order inucrred by the customer.
  </ResponseField>
          ...
          <ResponseField name="measurements" type="object">
            ...
            <Expandable title="Measurements" defaultOpen="true">
              ...
              <ResponseField name="unit" type="string or null">
                The unit of measurement for the package. Will either be `in` or `cm`.
              </ResponseField>
              ...
              <ResponseField name="weight_unit" type="string or null">
                The unit of measurement for the weight of the package. Will either be `lb` or `kg`.
              </ResponseField>
            </Expandable>
