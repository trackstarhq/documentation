...
Occasionally, however, the connection may not be fully able to access all the aspects of the underlying system. In that case, you may see these in your [Trackstar Link](/how-to-guides/trackstar-link) or under the Sync Errors tab in the UI:
...
- By generating a [magic link](/how-to-guides/trackstar-link#sending-a-magic-link) with the `Reinstall Connection Id (Optional)` field filled in
