...
description: "Embed the Trackstar Link component or send a Magic Link so customers can connect their systems"
---
...
This component can be embedded into your application, or sent as a "Magic Link" to your customers.
    ...
    <div style={{display: 'flex', justifyContent: 'center'}}>
      <img src="/images/link-steps-2.png" alt="Trackstar Link" width="250" style={{borderRadius: '12px'}} />
    </div>

<Note>
  While connecting, your customer is asked to grant access for each endpoint on the connection. Endpoints your org has [disabled](/how-to-guides/syncing-data#disabled-endpoints) are skipped.
</Note>
...
<html>
  ...
  <body>
      <div>
          <button id="trackstarButton">Connect Integration</button>
      </div>
  <body>
</html>
...
### Sending a Magic Link
  ...
  The remaining options sit under **Advanced** in the modal:
  ...
  - **Required Endpoints (Optional)**: Only show integrations that have the selected endpoints supported.
  - **Disabled Endpoints (Optional)**: These endpoints start turned off on the connection this link installs, on top of your org's [disabled endpoints](/how-to-guides/syncing-data#disabled-endpoints). Sync endpoints only.
  - **Enabled Endpoints (Optional)**: Re-enable endpoints your org has disabled, for the connection this link installs. Only shown when your org has endpoints disabled for the integration type.
