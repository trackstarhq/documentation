...
The Trackstar OpenAPI spec can be found at https://production.trackstarhq.com/openapi.json. The API documentation found
on this page is a stylized version of that spec.
...
<Note>
When filtering by a date, the most fastest and most efficient query is to use both `gte` and `lte` to filter by a date range.

i.e. `created_date[gte]=2026-01-01T00:00:00Z&created_date[lte]=2026-01-02T23:59:59Z`
</Note>
