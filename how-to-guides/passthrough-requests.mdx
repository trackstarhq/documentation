...
description: "Call an integration's own API through Trackstar using the credentials already stored on the connection"
---
...
Passthrough is supported by default for WMS and cart integrations that connect over a standard HTTP API.
