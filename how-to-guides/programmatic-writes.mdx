...
| line\_items.return\_cause.code | The reason code for the line item's return. The values in this field are different for different connections - for this connection they are "1", "13", or "3" | string | No |
| line\_items.return\_cause.return\_reason | The reason code for the line item's return. The values in this field are different for different connections - for this connection they are "damaged", "wrong size", or "no longer needed" | string | Yes |
...
| trackstar\_tags | The [Trackstar Tags](/how-to-guides/trackstar-tags) | string | No |
