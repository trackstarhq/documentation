...
For detailed information on the ```meta``` endpoint, see the [meta endpoint documentation](/wms-api/meta).
...
This schema conforms to the [JSON Schema Draft 04](https://json-schema.org/specification-links.html#draft-4) specification.
