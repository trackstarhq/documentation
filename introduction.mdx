...
description: "What Trackstar is and how to start building on the unified WMS, Cart, and Carrier API"
---
...
Using Claude Code, Cursor, or another coding agent? These docs are available as Markdown, an OpenAPI spec, installable agent skills, and an MCP server, and the guide below has prompts you can paste to get started.

<Card title="Build with AI Agents" icon="robot" href="/how-to-guides/build-with-ai">
  Ready-made prompts, agent instructions, and every machine-readable version of these docs.
</Card>
