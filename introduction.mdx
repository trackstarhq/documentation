...
### Agent development
Building with Trackstar using an AI coding agent? These resources are optimized for LLMs.

<CardGroup cols={2}>
  <Card title="llms.txt" icon="robot" href="https://docs.trackstarhq.com/llms.txt">
    An index of these docs for LLMs to navigate.
  </Card>
  <Card title="llms-full.txt" icon="file-lines" href="https://docs.trackstarhq.com/llms-full.txt">
    The full documentation as a single plain-text file to paste into an agent's context.
  </Card>
  <Card title="OpenAPI spec" icon="code" href="https://production.trackstarhq.com/openapi.json">
    The machine-readable spec for every endpoint.
  </Card>
  <Card title="Docs MCP server" icon="plug" href="https://docs.trackstarhq.com/mcp">
    Connect your agent to `https://docs.trackstarhq.com/mcp` to search these docs live.
  </Card>
</CardGroup>

You can also append `.md` to any docs page URL to get its Markdown source.
